...
$encryption4 = openssl_encrypt($simple_string4, $ciphering, $encryption_key, $options, $encryption_iv);
          ...
          $insertquery =  "INSERT INTO details(firstName, lastName, birthDate,  gender, religion, category, fatherName, motherName, income, institute, presentClass, presentCourse, classRoll, currentRoll, class12Pass, IFSC, ACnumber,Flag) VALUES ('$First_Name','$Last_Name','$DOB','$gender','$relegion','$category','$Father_Name','$Mother_Name','$encryption2','$Institute_Name','$course','$course_year','$encryption1','$Board_Name','$Year_Of_Passing','$encryption3','$encryption4','zero')";
    ...
    <div class="outer_box">
        ...
        <!-- ########################### ACADEMIC DETAILS ################ -->
            ...
            <h2 style="color: black;"><u>Academic Details</u></h2>
                ...
                <!-- **************12th BOARD NAME ************  -->
                <div class="form-group">
                    <label for="Board_Name">Current Roll.No:</label>
